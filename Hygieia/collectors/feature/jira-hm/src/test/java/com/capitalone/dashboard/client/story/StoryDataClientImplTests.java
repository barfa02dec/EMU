...
public class StoryDataClientImplTests {
	...
	public final void init() {
		...
		story.add(new String[] {"Story"});
		List<String>  sprint = new ArrayList<String>();
		sprint.add("custom_sprint");
		List<String>  epic = new ArrayList<String>();
		epic.add("custom_epic");
		List<String>  storyPoint = new ArrayList<String>();
		storyPoint.add("custom_storypoints");
		List<String>  teamField = new ArrayList<String>();
		teamField.add("custom_teamname");
		featureSettings.setJiraIssueTypeNames(story);
		featureSettings.setJiraSprintDataFieldName(sprint);
		featureSettings.setJiraEpicIdFieldName(epic);
		featureSettings.setJiraStoryPointsFieldName(storyPoint);
		featureSettings.setJiraTeamFieldName(teamField);
		featureSettings.setDeltaStartDate("2016-03-01T00:00:00.000000");
		featureSettings.setPageSize(25);
		List<String> jiraBaseUrl = new ArrayList<>();
		List<String> jiraQueryEndpoint = new ArrayList<>();
		
		jiraBaseUrl.add("https://jira.atlassian.com/");
		jiraQueryEndpoint.add("rest/api/latest/");
		featureSettings.setJiraBaseUrl(jiraBaseUrl);
		featureSettings.setJiraQueryEndpoint(jiraQueryEndpoint);
